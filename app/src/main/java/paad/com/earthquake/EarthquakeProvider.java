...
/**
 * Created by J_westendarp on 4/10/2015.
 */
public class EarthquakeProvider extends ContentProvider {
    public static final Uri CONTENT_URI = Uri.parse("content://paad.com.earthquakeprovider/earthquakes");
    ...
    public boolean onCreate() {
        ...
        dbHelper = new EarthquakeDatabaseHelper(context, EarthquakeDatabaseHelper.DATABASE_NAME, null,
    ...
    // Allocate the UriMatcher object, where a URI ending in 'earthquakes' will correspond to a
    // request for all earthquakes, and 'earthquakes' with a trailing '/[rowId]' will
    // represent a single earthquake row.
    static {
        uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        uriMatcher.addURI("paad.com.earthquakeprovider", "earthquakes", QUAKES);
        uriMatcher.addURI("paad.com.earthquakeprovider", "earthquakes/#", QUAKE_ID);
        uriMatcher.addURI("paad.com.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_QUERY, SEARCH);
        uriMatcher.addURI("paad.com.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_QUERY + "/*", SEARCH);
        uriMatcher.addURI("paad.com.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_SHORTCUT, SEARCH);
        uriMatcher.addURI("paad.com.earthquakeprovider", SearchManager.SUGGEST_URI_PATH_SHORTCUT + "/*", SEARCH);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        // If no sort order is sepcified, sort by date / time
        String orderBy;
        ...
        // Regiser the contexts ContentResolver to the notified if the cursor result set changes
    ...
    public Uri insert(Uri _uri, ContentValues values) {
        ...
        // Insert the new row. The call tot eh database.insert will return the row number if it is successful
